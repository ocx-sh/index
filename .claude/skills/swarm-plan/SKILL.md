...
## Design-record context (shared)

Identify involved surfaces, read `product-context.md` +
`.claude/artifacts/handover_from_ocx.md` +
`design_spec_registry_indirection.md` (§10/§11/§12 authoritative).
...
- **Stub**: components to create with `NotImplementedError` / stub exit
