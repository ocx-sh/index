...
breaking wire-contract change, `format_version` bump, new publish
pipeline, cross-surface refactor, protocol change). Preserve contract-first TDD.
...
- `handover_from_ocx.md` + `design_spec_registry_indirection.md` (§10/§11/§12 authoritative) for every surface touched
